...
function basedGroup(at: Entity, subType: EntitySubTypeGroup): Entity {
	const raw: GroupRaw = { sub_type: subType, side: BLUE, alive: 1, supplies: { ammo_supply_level: 100, fuel_supply_level: 100 }, sleep: 0, assist_timer: 0, member_count: 0, group_list_type: 0 };
