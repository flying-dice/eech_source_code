...
| H1 | `ui_menu/ingame/campaign/ca_hist.c` | With an empty campaign history (always the case headless), the original reads and can write index −1. The patch returns early. |
