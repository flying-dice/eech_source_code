...
9. **The war resolves.** In six simulated hours of Luxembourg (`recordings/`), red's troop insertions capture both blue airbases, and blue's air force dies out without a base to regenerate or rearm. That covers task generation and assignment, combat, attrition, regeneration, repair and capture.
